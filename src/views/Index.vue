  ...
  <a-layout class="h100vh">
    <a-layout-sider theme="dark" class="l-layout-sider" v-model="collapsed">
      <div class="l-layout-sider-image-header">
        <img v-show="!collapsed" class="l-layout-sider-image-header-logo" src="/img/HFMU_200x64px.svg" alt="">
        <img v-show="collapsed" class="l-layout-sider-image-header-logo" src="/img/HFMU_60x60px.svg" alt="">
